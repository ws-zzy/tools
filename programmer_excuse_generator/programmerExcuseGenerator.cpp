...
string excuses[] = {
    ...
    "our servers couldn't handle the traffic the app was recieving",
    "your machines processors must be too slow",
    "your pc is too outdated",
    "I haven't pushed the latest changes yet",
